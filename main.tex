\documentclass[a4paper,10pt]{jreport} %←先輩の10.5ptは対応していない。内部的に10ptになるみたいだから最初から10ptに設定

%========================================================
% パッケージ
%========================================================

%% 画像（PostScript, JPEG, PNG 等）
% \usepackage{epsfig} % \psfig{file=sample.eps,width=3cm} 用（未使用なら不要）
...
\usepackage{ulem}    % 下線
\usepackage{float}   % [H] を有効化（図表をその場に固定）
\usepackage{url}
\usepackage{multirow}
\usepackage[table]{xcolor}

%% フォント
% 現在の時間を表示する（※実際には times はフォント指定）
\usepackage{times} % Computer Modern の代わりに Times 系フォント
...
\title{意思決定重視学習を用いた \\ ポートフォリオ最適化}
\yearandmonth{令和 8 年 1 月 20 日提出}

%========================================================
% 本文
%========================================================
\begin{document}
\begin{CJK}{UTF8}{min} % UTF-8 エンコーディングとフォント設定
